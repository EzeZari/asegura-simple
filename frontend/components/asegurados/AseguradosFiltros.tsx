    ...
    <div className="flex flex-col lg:flex-row items-center gap-4 bg-white p-4 rounded-xl border border-gray-100 shadow-sm w-full">
      ...
      <div className="relative flex-1 w-full">
        ...
        <input 
          ...
          className="w-full pl-10 pr-4 py-2 border border-gray-200 rounded-lg focus:ring-2 focus:ring-green-600 outline-none transition-all" 
        />
      </div>
      ...
      <div className="flex items-center gap-3 w-full lg:w-auto">
        ...
        <div className="flex items-center gap-2 bg-gray-50 px-3 py-2 rounded-lg border border-gray-200">
          <div className={`w-2 h-2 rounded-full ${filtroEstado === 'Activos' ? 'bg-green-500' : filtroEstado === 'Inactivos' ? 'bg-red-500' : 'bg-gray-400'}`}></div>
          <select 
            value={filtroEstado} 
