...
export default function ImportarAseguradosModal({ isOpen, onClose, onSuccess }: Props) {
  ...
  return (
    <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-[200] p-4">
      <div className="bg-white dark:bg-gray-800 rounded-xl w-full max-w-lg shadow-xl relative animate-in fade-in zoom-in duration-200 border border-transparent dark:border-gray-700 transition-colors">
        ...
        <div className="p-6 border-b border-gray-100 dark:border-gray-700 flex justify-between items-center bg-gray-50/50 dark:bg-gray-900/50 rounded-t-xl transition-colors">
          <h2 className="text-xl font-bold text-gray-900 dark:text-white flex items-center gap-2 transition-colors">
            <FileSpreadsheet size={22} className="text-green-700 dark:text-green-500" /> Importar desde Excel
          </h2>
        ...
        <div className="p-6 flex flex-col gap-5">
          {/* 🔥 INFO BOX (Instrucciones) adaptada a oscuro */}
          <div className="bg-blue-50/50 dark:bg-blue-900/20 border border-blue-100 dark:border-blue-800/30 rounded-xl p-4 transition-colors">
            ...
            <div className="overflow-hidden rounded-lg border border-blue-200 dark:border-blue-800/30 bg-white dark:bg-gray-800 transition-colors">
              <table className="w-full text-left text-[10px] text-gray-600 dark:text-gray-300">
                <thead className="bg-blue-50 dark:bg-blue-900/40 text-blue-900 dark:text-blue-300 font-bold uppercase transition-colors">
                  <tr>
                    <th className="px-3 py-2 border-r border-blue-100 dark:border-gray-700">Nombre *</th>
                    <th className="px-3 py-2 border-r border-blue-100 dark:border-gray-700">Apellido</th>
                    <th className="px-3 py-2 border-r border-blue-100 dark:border-gray-700">DNI *</th>
                    <th className="px-3 py-2 border-r border-blue-100 dark:border-gray-700">Telefono</th>
                    <th className="px-3 py-2">Email</th>
                  </tr>
                </thead>
                <tbody>
                  <tr>
                    <td className="px-3 py-2 border-r border-gray-100 dark:border-gray-700 font-medium">Juan Perez</td>
                    <td className="px-3 py-2 border-r border-gray-100 dark:border-gray-700 text-gray-400 dark:text-gray-500 italic">(Opcional)</td>
                    <td className="px-3 py-2 border-r border-gray-100 dark:border-gray-700 font-medium font-mono">32111222</td>
                    <td className="px-3 py-2 border-r border-gray-100 dark:border-gray-700">341555666</td>
                    <td className="px-3 py-2">juan@mail.com</td>
                  </tr>
                </tbody>
              </table>
            </div>
            <p className="text-[10px] text-blue-700 dark:text-blue-400 mt-2 italic transition-colors">
          ...
          {!file ? (
            ...
            >
              ...
              <div className="text-center">
                <p className="text-sm font-bold text-gray-700 dark:text-gray-200 transition-colors">Hacé clic para seleccionar tu planilla</p>
                <p className="text-xs text-gray-400 dark:text-gray-500 mt-1 transition-colors">Soporta formatos .xlsx, .xls o .csv</p>
              </div>
            ...
            <div className="bg-gray-50 dark:bg-gray-900/50 border border-gray-200 dark:border-gray-700 rounded-xl p-4 flex items-center justify-between transition-colors">
              ...
              {!isProcessing && (
                <button onClick={() => { setFile(null); setPreviewData([]); }} className="text-gray-400 dark:text-gray-500 hover:text-red-500 dark:hover:text-red-400 p-1 font-bold text-xs transition-colors">
                  Cambiar
                </button>
              )}
            </div>
