  ...
  return (
    <div className="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm flex flex-col gap-4">
      ...
      <div className="flex flex-wrap gap-4 mt-2">
        <button onClick={() => exportarDatos('asegurados')} disabled={isExporting} className="flex items-center gap-2 bg-green-50 text-green-700 border border-green-200 hover:bg-green-100 px-5 py-3 rounded-xl font-semibold transition-all disabled:opacity-50">
          <Download size={18} /> Base Completa: Asegurados
        </button>
        <button onClick={() => exportarDatos('polizas')} disabled={isExporting} className="flex items-center gap-2 bg-green-50 text-green-700 border border-green-200 hover:bg-green-100 px-5 py-3 rounded-xl font-semibold transition-all disabled:opacity-50">
