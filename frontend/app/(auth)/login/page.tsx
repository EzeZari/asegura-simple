    ...
    return (
      <div className="w-full max-w-md flex flex-col gap-8 animate-in fade-in slide-in-from-right-4 duration-300">
        <div>
          ...
          <h1 className="text-3xl font-bold text-gray-900 tracking-tight mb-2">Verificación en dos pasos</h1>
        ...
        <form onSubmit={handleVerify2FA} className="flex flex-col gap-6">
          <input type="text" maxLength={6} placeholder="000000" value={codigo2fa}
            onChange={(e) => setCodigo2fa(e.target.value.replace(/[^0-9]/g, ''))} disabled={isLoading}
    ...
    <div className="w-full max-w-md flex flex-col gap-10 animate-in fade-in duration-300">
      ...
      <form onSubmit={handleLogin} className="flex flex-col gap-6 mt-2">
        ...
        <div className="relative">
          <input type={showPassword ? "text" : "password"} placeholder="Contraseña" value={password} onChange={(e) => setPassword(e.target.value)} disabled={isLoading}
        ...
        <div className="flex justify-end mt-1">
          <Link href="/recuperar" className="text-sm text-green-700 font-medium hover:underline">¿Olvidaste tu contraseña?</Link>
        </div>
